...
module.exports = class sexByName {
    constructor(surname, first_name, patronymic) {
     ...
     * @private
     */
    is_popular_name(first_name, gender) {
